    ...
    async def stats(_key: str = Depends(auth)):
        ...
        return {
            ...
            "safe_browsing": {
                ...
                "checks": int(db.get_state("sb_checks", "0")),
                "flagged": int(db.get_state("sb_flagged", "0")),
                "escalations": int(db.get_state("sb_escalations", "0")),
                "errors": int(db.get_state("sb_errors", "0")),
